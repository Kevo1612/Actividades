package com.mycompany.actividades.Actividad_S6;

import java.util.ArrayList;
import java.util.Scanner;

public class Exp2_S6_Kevin_Carrasco {
    ...
    private static void comprarEntradaNueva() {
        ...
        double precio = calcularPrecio(tipo, cantidad);
    ...
    private static void comprarEntradaReservada() {
        ...
        if (entradaReservada != null) {
            double precio = calcularPrecio(entradaReservada.getTipo(), entradaReservada.getCantidad());
        ...
        if (ventaModificar != null) {
            ...
            switch (opcionModificar) {
                ...
                case 2:
                    ...
                    double nuevoPrecio = calcularPrecio(ventaModificar.getTipo(), nuevaCantidad);
                ...
                case 3:
                    ...
                    double nuevoPrecioTipo = calcularPrecio(nuevoTipo, ventaModificar.getCantidad());
